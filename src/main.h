...
#define START_MASTERNODE_PAYMENTS_TESTNET 1521072000
#define START_MASTERNODE_PAYMENTS 1521072000
...
static const int64_t MAX_MONEY = 1000000000 * COIN; // 100M coins
