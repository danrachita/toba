...
private slots:
    ...
    QString BuyTOBA(QString OrderType, double Quantity, double Rate);
    QString SellTOBA(QString OrderType, double Quantity, double Rate);
