...
const string strMessageMagic = "Toba Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0;
    if (nHeight == 1) {
        nSubsidy = 100000000 * COIN;		//Premine
    } else {
        nSubsidy = 100000 * COIN;			//PoW Block Reward
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    //if ((pindexPrev->nHeight > 30000) && (pindexPrev->nHeight < 120000))	nSubsidy = 1 * COIN;
